...
# Final Economy Plugin - Fixed AttributeError, Normal Font & English Output
...
# --- MY RANK (Fixes the AttributeError) ---
async def my_rank(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Shows global rank and balance for the user."""
